...
if(isset($_POST['submit'])){
    $to = "clint@nordicdev.io"; // this is your Email address
    $from = $_POST['email']; 
    $name = $_POST['name'];
...
?>
			    <div class="intro">
			    <p>Interested in hiring me for your project or just want to say hi? Fill in the contact form below or send me an email to <a href="mailto:clint@nordicdev.io?subject=Let's build something">clint@nordicdev.io</a></p>
