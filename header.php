...
<title><?= isset($PageTitle) ? $PageTitle : "Default Title"?></title>
	...
	<meta name="description" content="Experienced technical consultant, software architect, freelance web developer and mobile app builder for hire in Minneapolis, Minnesota.">
...
<body>
	...
	<header class="header text-center">	    
		<div class="force-overflow">
			<h1 class="blog-name pt-lg-4 mb-0"><a href="index.php">Clint McMahon</a></h1>
			...
			<nav class="navbar navbar-expand-lg navbar-dark" >
				...
				<div id="navigation" class="collapse navbar-collapse flex-column" >
					...
					<ul class="navbar-nav flex-column text-left">
						...
						<li class="nav-item">
							<a class="nav-link" href="https://medium.com/@cwmcmhn" target="_blank" rel="noopener noreferrer"><i class="fas fa-blog fa-fw mr-2"></i>Blog</a>
						</li>
						<li class="nav-item">
