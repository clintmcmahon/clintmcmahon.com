					...
					<div class="row align-items-center">
						...
						<div class="resume-contact col-12 col-md-6 col-lg-4 col-xl-3">
							<ul class="list-unstyled mb-0">
								...
								<li class="mb-2"><i class="fas fa-envelope-square fa-fw fa-lg mr-2"></i><a class="resume-link" href="mailto:clint@nordicdev.io">clint@nordicdev.io</a></li>
								...
								<li class="mb-0"><i class="fas fa-map-marker-alt fa-fw fa-lg mr-2"></i>Minneapolis</li>
							</ul>
						</div><!--//resume-contact-->
					</div><!--//row-->
							...
							<section class="work-section py-3">
								...
								<div class="item mb-3">
									<div class="item-heading row align-items-center mb-2">
										<h4 class="item-title col-12 col-md-6 col-lg-8 mb-2 mb-md-0">Software Architect / Senior Developer / Consultant</h4>
										<div class="item-meta col-12 col-md-6 col-lg-4 text-muted text-left text-md-right">Nordic Dev | 2015 - Present</div>
										
									</div>
									<div class="item-content">
										<p>Design, architect and developed websites, mobile apps and provide technical consulting to various clients in a wide variety of industries.</p>
									</div>
								</div><!--//item-->
								<div class="item mb-3">
									<div class="item-heading row align-items-center mb-2">
